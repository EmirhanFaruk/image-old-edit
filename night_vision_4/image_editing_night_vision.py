...
# Modification date: Thu Jan  6 16:27:08 2022
...
def paths():
    ...
    if the_name_of_the_file == "" or the_name_of_the_file == "conda activate imgedit":
        ...
        the_name_of_the_file = os.getcwd() + "/"
    ...
    the_name_of_the_file2 = the_name_of_the_file.split("/")[2]
    ...
    if the_destination_file == "" or the_destination_file == "conda activate imgedit":
        ...
        the_destination_file = os.getcwd() + "/"
...
arr = os.listdir(the_name_of_the_file)
...
for i in range(larr):
    ...
    arr[i] = f"{the_name_of_the_file}/" + arr[i]





sussy_file_name = f"{the_name_of_the_file}/"
...
for i in range(len(arr)):
        ...
        arr[i] = "C:/Users/emirh/OneDrive/Bureau/My_World_Dont_Change/dosyalar/Kodlarim\Python/image_old_edit/the_images/" + arr[i]


        os.rename(arr[i], f"C:/Users/emirh/OneDrive/Bureau/My_World_Dont_Change/dosyalar/Kodlarim\Python/image_old_edit/the_images/sc_{i + 1}.png")
...
def load_bar(delta_time, start_time, photos_done, total_photos, arr, i):
    ...
    print(f"The destination folder: {the_destination_file[1:]}")
    ...
    green_bars_num = int((((photos_done) / len(arr)) * 50))


    green_bars = " " * green_bars_num


    white_bars = " " * (50 - green_bars_num)
...
arr.remove('/storage/emulated/0/Kodlarım/night_vision_3//image_editing_night_vision.py')
...
for i in range(len(arr)):
    ...
    path = f"{the_destination_file}/{the_name_of_the_file2}{the_name_of_the_file2}{prefixes}%#05d" % (i+1) + ".png"
