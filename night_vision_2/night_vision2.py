...
# Modification date: Wed Jan  5 16:15:32 2022
...
img_list = ["Sc1", "Sc2", "Sc3", "Sc4", "Sc5", "Sc6", "Sc7", "Sc8", "Sc9", "Sc10"]
...
for i in range(len(img_list)):
	...
	image = Image.open(f"{img_list[i]}.png")
	...
	moyenne = somme / len(the_cercle_list)
	
	if moyenne < 100:
		for da_baby in the_cercle_list:
			if da_baby[1][1] + 40 > 255:
				image.putpixel((da_baby[0][0], da_baby[0][1]), (0, 255, 0))
			else:
				image.putpixel((da_baby[1][0], da_baby[1][1]), (0, da_baby[1][1] + 40, 0))
	
	
	
	
	image.save(f"{img_list[i]}_edit5.png", "png")
	img_fin = time.time()
